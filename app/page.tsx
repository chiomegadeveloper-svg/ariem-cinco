...
export default function Home() {
  return <main>
    ...
    <footer id="contact"><div className="footer-brand"><Image src="/brand/ariem-logo.png" alt="Ariem Cinco" width={180} height={100}/><p>Communication that moves people.</p></div><div><p>Speaking engagements and partnerships</p><a href="mailto:mr.fivetheteacher@gmail.com"><Mail size={16}/> mr.fivetheteacher@gmail.com</a></div><Link href="/control-center">Owner control center</Link></footer>
  </main>;
}
